...
* @see app/Http/Controllers/ActivoController.php:38
* @route '/activos'
*/
...
* @see app/Http/Controllers/ActivoController.php:49
* @route '/activos/crear'
*/
...
* @see app/Http/Controllers/ActivoController.php:60
* @route '/activos'
*/
...
* @see app/Http/Controllers/ActivoController.php:297
...
* @see app/Http/Controllers/ActivoController.php:116
...
* @see app/Http/Controllers/ActivoController.php:137
...
* @see app/Http/Controllers/ActivoController.php:149
* @route '/activos/{activo}'
*/
...
* @see app/Http/Controllers/ActivoController.php:207
* @route '/activos/{activo}'
*/
...
* @see app/Http/Controllers/ActivoController.php:247

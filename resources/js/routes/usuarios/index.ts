...
/**
* @see \App\Http\Controllers\UsuarioController::rol
* @see app/Http/Controllers/UsuarioController.php:109
* @route '/usuarios/{usuario}/rol'
*/
export const rol = (args: { usuario: number | { id: number } } | [usuario: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: rol.url(args, options),
    method: 'post',
})
...
* @route '/usuarios/{usuario}/rol'
*/
rol.url = (args: { usuario: number | { id: number } } | [usuario: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { usuario: args }
    }
...
* @route '/usuarios/{usuario}/rol'
*/
rol.post = (args: { usuario: number | { id: number } } | [usuario: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: rol.url(args, options),
    method: 'post',
})
...
* @route '/usuarios/{usuario}/rol'
*/
const rolForm = (args: { usuario: number | { id: number } } | [usuario: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: rol.url(args, options),
    method: 'post',
})
...
* @route '/usuarios/{usuario}/rol'
*/
rolForm.post = (args: { usuario: number | { id: number } } | [usuario: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: rol.url(args, options),
    method: 'post',
})
